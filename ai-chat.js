...
class AIChat {
    ...
    loadConfig() {
        ...
        try {
            ...
            console.log('🌐 Checking for global_ai1_config:', globalConfigStr);
            
            if (globalConfigStr) {
                const parsed = JSON.parse(globalConfigStr);
                console.log('🌍 Loading GLOBAL AI config:', parsed);
                ...
                console.log('✅ AI config updated with GLOBAL settings:', config);
            } else {
